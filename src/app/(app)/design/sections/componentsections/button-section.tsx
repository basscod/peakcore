  ...
  return (
    <div className="space-y-24 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        {variants.map((v) => (
          <div key={v} className="space-y-8">
            ...
            <div className="space-y-4">
              {colors.map((c) => (
                <div key={`${v}-${c}`} className="grid grid-cols-[100px_1fr] items-center gap-8 p-4 radius-lg border stroke-light border-neutral-100/50 transition-colors">
      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-wrap items-end gap-10 p-8 radius-lg border stroke-light border-neutral-100">
          {sizes.map((s) => (
      ...
      {/* 3. States */}
      <div className="space-y-8">
        <h3 className="h3 uppercase border-l-4 border-primary-500 pl-4">Interactive States</h3>
